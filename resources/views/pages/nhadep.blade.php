...
<main>
        ...
        <div class="container">
            <div class="breadcrumb-wrapp">
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"> Kiến thức nhà đẹp</li>
                </ul>
            </div>
            <div>
                <h1 class="page-tittle">Kiến thức nhà đẹp</h1>
            </div>
        </div>
    ...
    <!-- gallery -->
    <section class="demo-thiet-ke">
        <div class="container">
           
            <div class="row">
                <div class="col-md-4">
                    <div class="hover01 colum ">
                        <div>
                            <figure><a href="#"><img src="https://picsum.photos/300/200?image=244" /></a></figure>
                            <p class="text-demo"><a href="#">Hạng III
                                    [Hỏi – Đáp] #1820: Công trình cấp IV, sửa chữa có cần chứng chỉ năng lực hoạt động
                                    xây
                                    dựng</a></p>
                        </div>
                    </div>
